...
QVariant PropertyValue::toQVariant() const
{
    ...
    case P_TYPE::TIMESIG_FULLMEASURE_REST_TYPE: return static_cast<int>(value<TimeSigFullMeasureRestType>());
...
PropertyValue PropertyValue::fromQVariant(const QVariant& v, P_TYPE type)
{
    ...
    case P_TYPE::TIMESIG_FULLMEASURE_REST_TYPE: return PropertyValue(TimeSigFullMeasureRestType(v.toInt()));
