...
static constexpr PropertyMetaData propertyList[] = {
    ...
    { Pid::TIMESIG_FULLMEASURE_REST_TYPE, true, "fullMeasureRestType", P_TYPE::TIMESIG_FULLMEASURE_REST_TYPE, PropertyGroup::APPEARANCE, DUMMY_QT_TR_NOOP("propertyName", "full measure rest type") },
